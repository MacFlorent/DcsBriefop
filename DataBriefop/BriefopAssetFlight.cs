...
{
	internal class BriefopAssetFlight : BriefopAssetGroup
	{
		#region Fields
		...
		#region CTOR
		public BriefopAssetFlight(BriefopManager parentManager, string sCoalitionName, string sCountryName, MizGroupFlight groupFlight) : base(parentManager, sCoalitionName, sCountryName, groupFlight)
		{
		...
		public void SetDisplayName()
		{
			...
			if (Playable && ParentManager.Miz.BriefopCustomData.NoCallsignForPlayableFlights)
