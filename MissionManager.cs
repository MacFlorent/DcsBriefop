...
namespace DcsBriefop
{
	internal class MissionManager
	{
		...
		public List<ElementExportFileType> ExportFileTypes { get; set; } = new List<ElementExportFileType>() { ElementExportFileType.Operations, ElementExportFileType.Coms, ElementExportFileType.Missions };
