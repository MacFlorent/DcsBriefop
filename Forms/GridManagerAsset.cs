...
//			m_dtSource.Columns.Add(GridColumn.Side, typeof(ElementAssetSide));
...
//			m_dtSource.Columns.Add(GridColumn.Function, typeof(string));
...
//			dr.SetField(GridColumn.Function, asset.Function);
//			dr.SetField(GridColumn.Task, asset.Task);
//			dr.SetField(GridColumn.Localisation, asset.ToStringLocalisation());
//			dr.SetField(GridColumn.Radio, asset.GetRadioString());
//			dr.SetField(GridColumn.Notes, asset.Information);
//			dr.SetField(GridColumn.Playable, ((asset as AssetFlight)?.Playable).GetValueOrDefault());
...
//			m_dgv.Columns[GridColumn.Included].HeaderText = "Inc";
