...
namespace DcsBriefop.Forms
{
	...
	{
		#region CTOR
		public UcBriefingPartParagraph(BaseBopBriefingPart bopBriefingPart, BopMission bopMission, UcBriefingPage ucBriefingPageParent) : base(bopBriefingPart, bopMission, ucBriefingPageParent)
		{
			InitializeComponent();
