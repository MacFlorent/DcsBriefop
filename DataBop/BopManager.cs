...
namespace DcsBriefop.DataBop
{
	internal class BopManager
	{
		...
		public Miz Miz { get; set; }
		public Theatre Theatre { get; set; }
		public BopCustomMain BopCustomMain { get; set; }
		public BopMain BopMain { get; set; }
		#endregion

		#region CTOR
		public BopManager(string sMizFilePath)
		{
		...
		public void MizLoad()
		{
			...
			Miz = new Miz(sLuaMission, sLuaDictionnary);
			Theatre = new Theatre(Miz.RootMission.Theatre);
			BopCustomMain = BopCustomMain.DeserializeJson(sJsonBopCustom);
			BopMain = new BopMain(this);
		...
		public void MizSave(string sFilePath)
		{
			...
			using (ZipArchive za = ZipFile.Open(sFilePath, ZipArchiveMode.Update))
			{
				...
				ToolsZip.ReplaceZipEntry(za, DataMiz.Miz.BriefopCustomZipEntryFullName, BopCustomMain.SerializeToJson(Newtonsoft.Json.Formatting.Indented));
			}
		}
