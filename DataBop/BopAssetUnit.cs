...
{
	internal class BopAssetUnit : BaseBop
	{
		#region Fields
		private MizUnit m_mizUnit;
		private BopAssetGroup m_parentAssetGroup;
		...
		#region CTOR
		public BopAssetUnit(BopManager parentManager, MizUnit mizUnit, BopAssetGroup parentGroup) : base(parentManager)
		{
			m_mizUnit = mizUnit;
